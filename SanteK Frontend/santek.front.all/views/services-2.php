                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="headline text-center">
                            ...
                            <h6>aidons les autres !</h6>
                            <h2>Action de transfert d'argent en ligne:</h2>
			...
			<div class="row">
				<div class="col-md-8">
					...
					<form id="contact-form" name="contact-form" method="POST" action="../send.php">
							...
							<p>
								<textarea class="col-12" id="message" name="message" rows="3" cols="25" placeholder="" ></textarea>
								<span></span>
								<label for="message">Message</label>
							</p>

							<button class="btn btn-default btn-outline waves waves-dark" id="submit" type="submit" name="submit" value="">submit <i class="decode-icon-cursor"></i></button>
					...
					<div class="widget widget-contact ml-lg-5">
						...
						<ul>
							...
							<li>
								...
								<li><a href="tel://+21620820760">+ 216 20 820 760</a></li>
							</li>
							<li>
								<i class="fa fa-envelope-o"></i>
								<a href="mailto:mariem.nacib@esprit.tn">admin@santek.tn</a>
							</li>
						</ul>
