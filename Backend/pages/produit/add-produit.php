...
<!-- Mirrored from androthemes.com/themes/html/medjestic/pages//add-patient.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Nov 2020 13:45:24 GMT -->
<head>
   ...
   <body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
      ...
      <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
         ...
         <div class="logo-sn ms-d-block-lg">
            ...
            <h6 class="text-center text-white mt-2">Cherni Souhail</h6>
         </div>
         <!-- Navigation -->
         <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
            ...
            <li class="menu-item">
               ...
               <span><i class="fas fa-user"></i>Produit</span>
               </a>
               <ul id="Produit" class="collapse" aria-labelledby="Produit" data-parent="#side-nav-accordion">
                  <li> <a href="add-patient.html">ajouter produits</a> </li>
                  <li> <a href="pages/Produit/afficherPromotion.php">Produit List</a> </li>
...
foreach($listePromotions as $row){
	...
	<td><img src='<?php  echo $row['imageProduit'] ?> '   width="500" height="350"></a>  
    </td>
...
<link rel="stylesheet" href="style.css">
               ...
               <div class="col-lg-12">
                        <div class="card">
                            <div  class="card-body"><p  align="center"><u>Liste de produits: </u>
                                <div class="table-responsive">
                                    <table class="table table-striped mb-0">
                                        <thead>
                        ...
                        <form class="needs-validation" novalidate>
                           ...
                           <div class="form-row">
                              <div class="col-md-6 mb-2">
                                 <label for="validationCustom001"> Réference </label>
                                 <div class="input-group">
                                    <input type="text" class="form-control"  placeholder="Réference" name="id" required>

                                 </div>
                                 <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                       <label for="validationCustom004" >Nom_produit</label>
                                       <div class="input-group">
                                          <input type="text" class="form-control" placeholder="Entrez le Nom_produit" name="nomProduit"  required>
                                 ...
                                 <label for="categorie">Catégorie</label>
                                   <div class="input-group">
                                    <select class="form-control" id="categorie"  name="categorie" required>
                                       ...
                                       <option value="Beauté & Bien étre">Beauté & Bien étre  </option>  
                           ...
                           <div class="form-row">
                              <div class="col-md-6 mb-3">
                                 ...
                                 <div class="custom-file">
                                    <input type="file" class="form-control"  name="imageProduit" placeholder="imageProduit" required>
                           ...
                           <button class="btn btn-warning mt-4 d-inline w-20" type="submit">réinitialiser</button>
                           <input class="btn btn-primary mt-4 d-inline w-20"  name="ajouter" type="submit" value="ajouter">
                        </form>
                    ...
                    <form class="needs-validation" novalidate>
                      <div class="form-row">
                        <div class="col-md-4 mb-3">
                          <label for="validationCustom01">Produit Name</label>
                          <div class="input-group">
                ...
                <div class="ms-panel ms-panel-bshadow-none">
                  ...
                  <div class="ms-panel-body">
                    <form class="needs-validation" novalidate>
                      <div class="form-row">
                        <div class="col-md-4 mb-3">
                          <label for="validationCustom09">Produit Name</label>
                          <div class="input-group">
                ...
                <div class="ms-panel ms-panel-bshadow-none">
                  ...
                  <div class="ms-panel-body">
                    <form class="needs-validation" novalidate>
                      <div class="form-row">
                        <div class="col-md-4 mb-3">
                          <label for="validationCustom16">Produit</label>
                          <div class="input-group">
...
<!-- Mirrored from androthemes.com/themes/html/medjestic/pages/patient/add-patient.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Nov 2020 13:45:24 GMT -->
</html>
