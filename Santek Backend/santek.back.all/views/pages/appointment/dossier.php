...
<!-- Mirrored from androthemes.com/themes/html/medjestic/pages/appointment/add-appointment.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Nov 2020 13:45:30 GMT -->
<head>
      ...
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
            <li class="dropdown-menu-header">
              <h6 class="dropdown-header ms-inline m-0"><span class="text-disabled">Welcome, Cartelo</span></h6>
            </li>
            <li class="dropdown-divider"></li>
        ...
        <div class="col-xl-12 col-md-12">
          <div class="ms-panel">
            <div class="ms-panel-header ms-panel-custome">
              ...
              <a href="appointment-list.php" class="ms-text-primary">Appointment List</a>
            </div>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-3">
                                        ...
                                        <p>
                                            <input class="col-12" id="nom_patient" type="text" name="nom_patient" placeholder="" required>
                                            <span></span>
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        ...
                                        <p>
                                            ...
                                            <span></span>
                                            <label for="date_n">Date Of Birth</label>
                                        </p>
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        ...
                                        <p>
                                            ...
                                            <span></span>
                                            <label for="email">Adresses</label>
                                        </p>
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        ...
                                        <p>
                                            <input class="col-12" id="faxe" type="number" name="faxe" placeholder="" required>
                                            <span></span>
                                ...
                                <p>
                                    ...
                                    <span></span>
                                    <label for="observations">Report type</label>
                                </p>

                                <button class="btn btn-default waves" id="submit" type="submit" name="submit" value="">Generate Report</button>
