                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb pl-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ajouter un participant</li>
                            </ol>
                        </nav>
                    </div>
...
<div class="ms-panel-header ms-panel-custome">
                                <h6>Ajouter Des participants</h6>
         ...
         <div>
          <input type="submit" value="Valider" name="ajouterP" class="btn btn-primary" id="ajouterP"/>
    ...
    <?PHP
            ...
            $listeEvent=$participant1C->afficherparticipants();
            ...
            <h4><i class="fa fa-angle-right"></i>Les participants :</h4>
            <hr>
            <table class="table">
            ...
            foreach($listeEvent as $row){
                ...
                <tbody>
                <tr>
                  <td><?PHP echo $row['nom_par']; ?></td>
                <td><?PHP echo $row['prenom_par']; ?></td>
